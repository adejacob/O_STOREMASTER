...
<body class="">
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <div class="container">
        ...
        <button class="navbar-toggler" data-toggle="collapse" data-target="#navCode">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navCode">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="why.html" class="nav-link">Why Outfit</a>
                </li>
                <li class="nav-item">
  ...
  <!-- ABOUT SECTION -->
  <section id="about" class="py-3 text-success">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1>What We Do</h1>
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum sequi necessitatibus deleniti accusamus provident dignissimos numquam fuga nulla quia voluptatibus, dolore voluptate excepturi accusantium dolores temporibus fugit, voluptas velit omnis!</p>
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum sequi necessitatibus deleniti accusamus provident dignissimos numquam fuga nulla quia voluptatibus, dolore voluptate excepturi accusantium dolores temporibus fugit, voluptas velit omnis!</p>
        </div>
        <div class="col-md-6">
          <img src="img/opportunity-bottom-banner-2000wide.jpg" alt="" class="about-img img-fluid rounded-circle d-none d-md-block">
        </div>
      </div>
    </div>
  </section>
...
All of our actions seek to improve belief and trust in all of our relationships.
  ...
  <!-- TESTIMONIALS -->
  <section id="testimonial-section" class="p-4 bg-secondary text-white">
    <div class="container">
...
<footer id="main-footer" class="text-center bg-dark p-4">
  <div class="container">
      <div class="row">
          <div class="col">
              <p class="lead">Copyright 2018 &copy; OUTFITSYSTEMS | ALL RIGHTS RESERVED</p>
          </div>
      </div>
  </div>
</footer>
